...
namespace WebsiteClothesSecondEdition.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public MaterialsController(Website2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Materials != null ? 
                          ...
                          Problem("Entity set 'Website2Context.Materials'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Website2Context.Materials'  is null.");
            }
            var material = await _context.Materials.FindAsync(id);
            if (material != null)
            {
