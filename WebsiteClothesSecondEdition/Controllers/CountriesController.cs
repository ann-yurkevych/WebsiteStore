...
namespace WebsiteClothesSecondEdition.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public CountriesController(Website2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Countries != null ? 
                          ...
                          Problem("Entity set 'Website2Context.Countries'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Website2Context.Countries'  is null.");
            }
            var country = await _context.Countries.FindAsync(id);
            if (country != null)
            {
