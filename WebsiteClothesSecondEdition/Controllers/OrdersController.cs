...
namespace WebsiteClothesSecondEdition.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(Website2Context context)
        {
            _context = context;
        }
        ...
        {
            var website2Context = _context.Orders.Include(o => o.Product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Website2Context.Orders'  is null.");
            }
            var order = await _context.Orders.FindAsync(id);
            if (order != null)
            {
